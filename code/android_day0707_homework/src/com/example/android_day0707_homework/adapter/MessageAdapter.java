...
public class MessageAdapter extends BaseAdapter {
	...
	public static void updateMessage(List<Message> messages) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String person = message.getSender();
		...
		viewHolder.textView2.setText(new SimpleDateFormat().format(message.getDate()));
		return view;
	}
